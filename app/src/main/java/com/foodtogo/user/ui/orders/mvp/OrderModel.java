...
public class OrderModel implements OrderContractor.Model {
    ...
    OrderModel(OrderPresenter presenter, AppRepository appRepository1) {
                ...
                .subscribeWith(new DisposableSingleObserver<BaseResponse<OrderDetailResponse>>() {
                    ...
                    public void onSuccess(BaseResponse<OrderDetailResponse> baseResponse) {
                        if (baseResponse.getCode() == 200) {
                            mPresenter.onOrderDetailResponse(baseResponse.getData());
                        } else {
