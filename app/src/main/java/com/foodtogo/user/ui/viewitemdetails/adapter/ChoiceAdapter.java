...
public class ChoiceAdapter extends RecyclerView.Adapter<ChoiceAdapter.ChoiceItemHolder> implements AppConstants {
    ...
    public ChoiceAdapter(Context context, List<Choice> choiceLists) {
