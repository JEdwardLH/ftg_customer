...
public class TotalWalletAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public TotalWalletAdapter(Context context, List<UsedDetail> orderArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                final TotalWalletAdapter.ItemVH itemVH = (TotalWalletAdapter.ItemVH) holder;
                if (usedDetail.getType().equals(REFERRAL_HISTORY)) {
                    String amountDetails = usedDetail.getOrdCurrency() +  usedDetail.getUsedAmount();
                    itemVH.tvOrderIdTxt.setText("Referred Email");
                    itemVH.tvOrderId.setText(usedDetail.getOrderId());
                    itemVH.tvDateTxt.setText("Offer Percent");
                    itemVH.tvDate.setText(usedDetail.getOrderDate() + " %");
                    itemVH.tvAmountTxt.setText("Amount Added");
                    itemVH.tvAmount.setText(amountDetails);
                    itemVH.dateContainer.setVisibility(View.VISIBLE);
                } else {
                    String amountDetails = usedDetail.getOrdCurrency() + usedDetail.getUsedAmount();
                    itemVH.tvOrderIdTxt.setText("Wallet Detail");
                    itemVH.tvOrderId.setText(usedDetail.getOrderId());
                    ...
                    itemVH.tvAmount.setText(amountDetails);
                    itemVH.dateContainer.setVisibility(View.GONE);
                }
                break;
