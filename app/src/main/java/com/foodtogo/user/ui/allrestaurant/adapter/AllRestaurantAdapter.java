...
public class AllRestaurantAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public AllRestaurantAdapter(Context context, List<AllRestautrantDetail> allRestaurants) {
        this.allRestaurantDetails = allRestaurants;
        this.allRestaurantDetailFiltered = allRestaurants;
        this.mContext = context;
    }

    public void setItemDetailsListener(RestaurantDetailListener _itemDetailListener) {
        this.itemDetailListener = _itemDetailListener;
    }
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                itemVH.itemView.setOnClickListener(v ->
                        itemDetailListener.itemClick(allRestaurantDetail)
                );
                break;
