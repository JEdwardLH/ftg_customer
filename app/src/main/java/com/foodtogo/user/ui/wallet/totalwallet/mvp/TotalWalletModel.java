...
public class TotalWalletModel implements TotalWalletContractor.Model {


    private TotalWalletPresenter mPresenter;
    private CompositeDisposable disposable = new CompositeDisposable();
    private AppRepository appRepository;
    private ApiInterface apiInterface;

    TotalWalletModel(TotalWalletPresenter presenter, AppRepository appRepository1) {
                ...
                .subscribeWith(new DisposableSingleObserver<BaseResponse<WalletBalanceResponse>>() {
                    ...
                    public void onSuccess(BaseResponse<WalletBalanceResponse> baseResponse) {
                        if (baseResponse.getCode() == 200) {
                            mPresenter.onLoadMoreTotalWallet(baseResponse.getData());
                        } else {
