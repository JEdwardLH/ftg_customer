package com.foodtogo.user.ui.wallet.totalwallet.fragment;
...
import com.foodtogo.user.ui.wallet.adapter.TotalWalletAdapter;
import com.foodtogo.user.ui.wallet.totalwallet.mvp.TotalWalletContractor;
import com.foodtogo.user.ui.wallet.totalwallet.mvp.TotalWalletPresenter;
...
public class TotalWallet extends BaseFragment implements TotalWalletContractor.View {
    ...
    TotalWalletPresenter myCartPresenter;
    TotalWalletAdapter adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myCartPresenter = new TotalWalletPresenter(this, appRepository);
        setRecyclerView();
        usedDetailList = getArguments().getParcelableArrayList(TOTAL_WALLET);
    ...
    private void loadListView(String message) {
    ...
    private void setRecyclerView() {
        ...
        adapter = new TotalWalletAdapter(getActivity(), usedDetailList);
    ...
    private void loadNextPage() {
        myCartPresenter.requestTotalWallet(currentPage);
    }
    ...
    @Override
    public void showTotalWalletLoadMore(WalletBalanceResponse walletBalanceResponse) {
        adapter.removeLoadingFooter();
        isLoading = false;
