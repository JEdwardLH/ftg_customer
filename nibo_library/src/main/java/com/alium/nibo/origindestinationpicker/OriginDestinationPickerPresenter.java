...
public class OriginDestinationPickerPresenter extends BaseNiboPresenter<OriginDestinationContracts.View> implements
        OriginDestinationContracts.Presenter {
    ...
    @Override
    public void setGoogleAPIKey(String apiKey,String lang) {
        super.setGoogleAPIKey(apiKey,lang);
