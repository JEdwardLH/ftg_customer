...
public class GeocodeCordinatesUseCase extends BaseUseCase {
    ...
    protected Observable getObservable(Params params) {
        ...
        String language = params.getString(NiboConstants.LANGUAGE_MAP, "en");
        System.out.println("language:**"+language);
        return geoCodingRepository.getObservableAddressStringFromLatLng(latitude, longitude, apiKey,language);
    }
}
